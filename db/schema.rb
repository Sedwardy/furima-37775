...
ActiveRecord::Schema.define(version: 2022_04_12_035021) do
  ...
  create_table "selectors", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "users", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.string "hurigana_last_name", null: false
